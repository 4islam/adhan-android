...
function PrayTime(){
    ...
    this.Ahmadiyya = 8; //Tarbiyyat Website as approved by Hadhrat Khalifatul Maseeh IV ra
    // Juristic Methods
    ...
    this.calcMethod = 8; // caculation method
    this.asrJuristic = 0; // Juristic method for Asr
    this.dhuhrMinutes = 0; // minutes after mid-day for Dhuhr
    this.adjustHighLats = 3; // adjusting method for higher latitudes
    ...
    //this.methodParams[this.Ahmadiyya] = new Array(11.9, 1, 1, 0, 12.3); //added 1 minutes not 5
